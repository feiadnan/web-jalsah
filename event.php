...
<head>
    ...
    <link rel="stylesheet" href="css/style.event.css" id="theme-stylesheet">
                        ...
                        <div class="row">
                            ...
                            <div class="post col-xl-6">
                                <div class="post-thumbnail hovereffect ">
                                    <a href="post.html"><img src="images/logo/event-blog.jpg" alt="..."
                                            class="img-fluid">
                                        <div class="texthov">
                            ...
                            <div class="post col-xl-6">
                                <div class="post-thumbnail hovereffect">
                                    <a href="post.html"><img src="images/logo/event-blog2.jpg" alt="..."
                                            class="img-fluid">
                                        <div class="texthov">
                                            <h4>18 Oktober 2019</h4>
                            ...
                            <div class="post col-xl-6">
                                <div class="post-thumbnail hovereffect"><a href="post.html"><img
                                            src="images/logo/event-blog3.jpg" alt="..." class="img-fluid">
                            ...
                            <div class="post col-xl-6">
                                <div class="post-thumbnail hovereffect"><a href="post.html"><img
                                            src="images/logo/event-blog4.jpg" alt="..." class="img-fluid">
